...
const TABS = [
  ...
  },
  {
    ...
    items: [
      {
        q: '주간 당번표 만들기 (자동 로테이션)',
        steps: [
          '대시보드 → "🧹 집안일" 열기',
          '위쪽 "🔄 자동 로테이션" 버튼 한 번 누르기',
          '한 주치 당번표가 자동으로 배정돼요. (매주 담당이 공평하게 순환)',
        ],
        note: '다시 누르면 그 주 당번표를 새로 짭니다(완료 기록도 초기화). 보통 주 시작에 한 번만 눌러요.',
      },
      {
        q: '담당 바꾸기 / 수정하기',
        steps: [
          '가족 이름(칩)을 누르면 그 사람의 집안일 목록이 떠요.',
          '각 항목에서 담당 이모지를 눌러 다른 사람으로 바꿔요.',
          '🗑로 삭제, 체크로 완료 처리도 돼요.',
          '또는 "✏️ 수동 지정"을 켜고 당번표 칸을 탭하면 담당자가 순서대로 바뀝니다.',
        ],
      },
      {
        q: '오늘 할 일 체크 + 포인트 받기',
        steps: [
          '"오늘 내 할 일"에서 끝낸 집안일을 체크해요.',
          '체크하면 포인트가 쌓여요. (난이도별 10~20P)',
          '"이번 주 보상까지" 막대가 차오릅니다.',
        ],
      },
      {
        q: '보상과 가족 완료 현황 보기',
        steps: [
          '"이번 주 보상까지"에서 내 포인트 / 목표를 확인해요.',
          '목표를 채우면 보상(용돈·미디어 시간·특권 중 택1)을 받아요.',
          '"가족별 완료 현황"에서 모두의 진행률을 함께 봐요.',
        ],
      },
      {
        q: '(부모) 미완료 알림 보내기',
        steps: [
          '엄마·아빠 계정에는 "⏰ 미완료 알림"이 보여요.',
          '안 한 집안일 옆 "콕 찌르기"를 누르면 가족 채팅으로 알림이 가요.',
        ],
      },
    ],
  },
    ...
    items: [
      {
        q: '포인트 모으기',
        steps: [
          '집안일을 완료하고 체크하면 포인트가 쌓여요. (난이도별 10~20P)',
          '쌓인 포인트는 대시보드 "🛒 보상 상점"에서 확인해요.',
        ],
      },
      {
        q: '보상 교환하기',
        steps: [
          '대시보드 → "🛒 보상 상점" 열기',
          '갖고 싶은 보상의 포인트 버튼을 눌러 교환해요.',
          '용돈·게임시간·면제권·메뉴 선택권 등 다양해요.',
          '포인트가 부족하면 버튼이 회색이 돼요.',
        ],
        note: '교환하면 "내 쿠폰함"에 들어가고, 부모님 승인 후 사용할 수 있어요.',
      },
      {
        q: '내 쿠폰함 보기',
        steps: [
          '상점 화면의 "내 쿠폰함" 탭에서 교환한 보상과 상태(신청/승인/사용)를 확인해요.',
        ],
      },
      {
        q: '(부모) 보상 승인·환불',
        steps: [
          '엄마·아빠 계정에는 "승인" 탭이 보여요.',
          '아이가 교환한 보상을 승인 / 사용완료 / 취소·환불 처리할 수 있어요.',
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        steps: [
          '대시보드 → "📐 수학" 열기',
          '레벨 선택: 초6·연산 / 중1 / 중2 / 중3',
          '문제가 나오면 ①②③④ 중 정답을 골라요.',
          '맞으면 정답, 틀리면 풀이로 확인해요.',
        ],
        note: '중1을 충분히 맞히면 중2 → 중3으로 올라가요. 문제는 매번 새로 생성돼요(무한 연습).',
      },
      {
        q: '풀이 보기',
        steps: [
          '문제 아래 "🧩 풀이 보기"를 누르면 단계별 풀이가 나와요.',
          '정답과 함께 어떻게 푸는지 확인하고 다음 문제로 넘어가요.',
        ],
      },
    ],
  },
